        ...
        <div className="Mesme">
            <form className="form1" >
                ...
                <div className="formInput1">
                    <label htmlFor="email" className='messageLabel'> Email: </label> <br />
                    <input type="text" name="email" placeholder="Enter your email" className="input1"/>
                </div>
                <div className="formInput1">
                    <label htmlFor="name" className='messageLabel'> Name: </label> <br />
                    <input type="text" name="name" placeholder="Enter your name" className="input1"/>
                </div>
                <div className="formInput1">
                    <label htmlFor="tel" className='messageLabel'> Phone Number: </label> <br />
                    <input type="tel" name="tel" placeholder="Enter your phone number" className="input1"/>
                </div>
                <div className="formInput1">
                    <label htmlFor="message" className='messageLabel'> Message: </label> <br />
